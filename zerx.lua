...
local zerxloader = Instance.new("TextLabel")
...
zerxloader.Name = "zerxloader"
zerxloader.Parent = Loader
zerxloader.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
zerxloader.BackgroundTransparency = 1.000
zerxloader.BorderColor3 = Color3.fromRGB(0, 0, 0)
zerxloader.BorderSizePixel = 0
zerxloader.Position = UDim2.new(0.123442277, 0, 0.157894731, 0)
zerxloader.Size = UDim2.new(0, 154, 0, 39)
zerxloader.Font = Enum.Font.JosefinSans
zerxloader.Text = "\"zerx hub\""
zerxloader.TextColor3 = Color3.fromRGB(255, 255, 255)
zerxloader.TextSize = 20.000
zerxloader.TextWrapped = true
zerxloader.TextTransparency = 1
...
local pop = ts:Create(zerxloader, TweenInfo.new(1), {TextTransparency = 0})
pop:Play()
...
local trans = ts:Create(zerxloader, TweenInfo.new(1.5), {TextTransparency = 1})
trans:Play()
...
local UICorner_3 = Instance.new("UICorner")
local zerxname = Instance.new("TextLabel")
...
zerxname.Name = "zerxname"
zerxname.Parent = Title
zerxname.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
zerxname.BackgroundTransparency = 1.000
zerxname.BorderColor3 = Color3.fromRGB(0, 0, 0)
zerxname.BorderSizePixel = 0
zerxname.Position = UDim2.new(0, 0, -0.000333150238, 0)
zerxname.Size = UDim2.new(0, 329, 0, 25)
zerxname.Font = Enum.Font.JosefinSans
zerxname.Text = "\"zerx hub\""
zerxname.TextColor3 = Color3.fromRGB(255, 255, 255)
zerxname.TextSize = 14.000
zerxname.TextWrapped = true
